        ...
        <div id="card-section">
          ...
          <div id="card3" class="manage-card">
            <el-upload
              ...
              action="http://rhwu.fun/hsbd/file/addFile"
...
const create = () => {
  axios
    .get('http://rhwu.fun/hsbd/user/article/page?pageNo=1&pageSize=100&isAsc=false')
  ...
  axios
    .get('http://rhwu.fun/hsbd/type/page?pageNo=1&pageSize=10&isAsc=false')

    .then((res) => {
      typeList.value = res.data.data
    })
  axios
    .get('http://rhwu.fun/hsbd/message/getAll')
...
function addEssay() {
  ...
  axios.post(`http://rhwu.fun/hsbd/user/essay/add`, data)
}
create()
function changePage() {
  const pageNo = currentPage.value
  axios
    .get(`http://rhwu.fun/hsbd/user/article/page?pageNo=${pageNo}&pageSize=10&isAsc=false`)
    .then((res) => {
      articleList.value = res.data.data
    })
}
...
function addType() {
  axios.post(`http://rhwu.fun/hsbd/type/add?name=${input.value}`).then((res) => {
    create()
  })
}
...
function onEditType(row) {
  ...
  ElMessageBox.prompt('Please input your type', 'Tip', {
    ...
    .then(({ value }) => {
      ...
      axios.post(`http://rhwu.fun/hsbd/type/update`, data).then((res) => {
        create()
      })
    })
    .catch(() => {
