    ...
    nextTick(async () => {
      ...
      for (var i = 0; i < commentList.value.length; i++) {
        ...
        while (whileIdList[0] != null) {
          ...
          await axios
            .get(`http://rhwu.fun/hsbd/user/comment/getTwo/${whileId}`)
            .then((res) => {
...
axios.get(`http://rhwu.fun/hsbd/user/article/${id}`).then((data) => {
...
function addComment() {
  ...
  axios.get(`https://api.usuuu.com/qq/${myQQ.value}`).then((res) => {
    ...
    axios
      .post('http://rhwu.fun/hsbd/user/comment/addOne', {
        source: 1,
        sourceId: id,
        img: qqImg,
        name: qqName,
...
function addTwoComment(indexId: any) {
  ...
  axios.get(`https://api.usuuu.com/qq/${myQQ.value}`).then((res) => {
    ...
    qqImg = ` http://q2.qlogo.cn/headimg_dl?dst_uin=${myQQ.value}&spec=100`
    axios
      .post('http://rhwu.fun/hsbd/user/comment/addTwo', {
        source: 1,
        targetId: indexId,
        img: qqImg,
        name: qqName,
